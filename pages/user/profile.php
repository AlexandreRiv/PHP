...
?>
    ...
    <div class="max-w-5xl mx-auto px-4 py-12">
        ...
        <div class="mt-10 bg-linear-to-br from-tft-card to-tft-card-deep border border-red-500/30 rounded-xl overflow-hidden">
            <div class="border-b border-red-500/30 px-6 py-4">
                <h2 class="font-tft text-xl font-bold text-red-400">Zone dangereuse</h2>
            </div>
            <div class="px-6 py-6">
                <p class="text-gray-400 text-sm mb-4">
                    La suppression de votre compte est <strong class="text-red-400">irréversible</strong>.
                    Toutes vos données (collection, succès, temps de jeu) seront définitivement perdues.
                </p>
